...
class Config(object):
    ...
    COMPILATION_MEMORY_LIMIT_KB = os.environ.get('COMPILATION_MEMORY_LIMIT_KB') or 524288
    ...
    GENERATOR_EXECUTION_TIME_LIMIT_MS = os.environ.get('GENERATOR_EXECUTION_TIME_LIMIT_MS') or 10000
